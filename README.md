...
3. Иногда модель страдает проблемами смещения цвета объекта
4. Также модель может галюцинировать и докидывать мелкие детали объекту, который он не содержал изначально.
